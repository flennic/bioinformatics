...
The number of features is (-1 as the )
...
count(rownames(autcon))

```


- Do you think the distribution of objects is balanced?

```{r}

# This question is so unspcific....
plot(autcon)
...
- You can use the ```View()``` function to display the data: ```View(autcon)```
