...
Our query sequence is found at *"Caenorhabditis elegans chromosome V"* and its range is between 6528 and 8027. We can see chromosome name in the figure of question 3.3.
...
get_exon = function(seq, start, end){
  ...
  print(fst_index)
  print(fst_index + (end-start))
  return(substr(seq, fst_index, fst_index + (end-start)))
}

fasta_file = readLines("2.3_nucleotid-sequence.FASTA")
...
writeLines(exon1, file("exon1.txt"))
writeLines(exon2, file("exon2.txt"))
writeLines(exon3, file("exon3.txt"))
writeLines(exon4, file("exon4.txt"))
```
