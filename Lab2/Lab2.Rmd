...
:Compare to the tree from original data, tree from two simulated data is more balanced. From the tree based on original data, we can see that lizards are phylogenetically related so we can group them into few family group. However, tree from two simulated data are more randomly distributed, less lizards are phylogenetically related.
