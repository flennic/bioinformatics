...
## TODO
# - 2.3 clarify the distance metric (ask other groups, name it, use a different library)
# - description how to Use ClustalOmega
...
We looked up the source code at GitHub (<https://github.com/cran/seqinr/blob/master/R/dist.alignment.R#L27>)
where it says, that the C distance function is used (line 27). The call looks
like this:
