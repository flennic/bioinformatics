...
# Get the distance matrices. The distance function is "unclear", the
# documentation says "specified distance measure". We can also use a different
# one.
dist_mat_original =
  as.matrix(dist.alignment(original_as_alignment, matrix = "identity"))
dist_mat_sim_sample =
  as.matrix(dist.alignment(sim_sample_as_alignment, matrix = "identity"))
dist_mat_sim_tree =
  as.matrix(dist.alignment(sim_tree_as_alignment, matrix = "identity"))
